...
import 'package:sharebowl/widgets/radio.dart';
  ...
  void initState() {
    ...
    setState(() {
      FirebaseFirestore.instance
          ...
          .doc("ingredientsmaster")
          .snapshots()
          .listen((event) => ingredientsList = event.data()!);
    });
  }
          ...
          children: <Widget>[
            SimpleDialogOption(
                ...
                onPressed: () async {
                  ...
                  Uint8List file =
                      await StorageMethods().captureImage(ImageSource.camera);
                  setState(() {
                    image = file;
                  });
                }),
            SimpleDialogOption(
                ...
                onPressed: () async {
                  ...
                  Uint8List file =
                      await StorageMethods().captureImage(ImageSource.gallery);
                  setState(() {
                    image = file;
                  });
                }),
